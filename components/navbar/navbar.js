                ...
                <div className="relative flex justify-between lg:gap-8 xl:grid xl:grid-cols-12">
                  ...
                  {isLoggedIn ? (
                    ...
                    <div className="hidden lg:flex lg:items-center lg:justify-end xl:col-span-4">
                      <Link
                        href="/auth/login"
                        className="ml-6 inline-flex items-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                      >
                        Log in
                      </Link>
                      <Link
              ...
              <Popover.Panel as="nav" className="lg:hidden" aria-label="Global">
                ...
                {isLoggedIn ? (
                  ...
                  <div className="mx-auto mt-6 max-w-3xl px-4 sm:px-6">
                    <Link
                      href="/auth/login"
                      className="flex items-center justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-blue-700"
                    >
                      Log in
                    </Link>
                    <Link
                      href="/auth/signup"
                      className="mt-3 flex items-center justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-blue-700"
                    >
                      Sign up
                    </Link>
                  </div>
